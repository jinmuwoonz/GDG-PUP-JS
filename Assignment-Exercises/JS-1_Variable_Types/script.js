...
// Using let
let name = "Daniel Atega"; // Define a string here, e.g., "Juan Cruz"
let age = 20; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["gaming", "watching", "exercising"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
var colors = ["black", "red", "blue"]; // Define an array here, e.g., ["red", "green", "blue"]
